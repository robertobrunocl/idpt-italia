...
Infine, una piccola parte VoID descrive il grafo dall'interno: dichiara quante triple contiene, 116.633 al momento dell'emissione finale, indica con `dcat:accessURL` l'indirizzo da cui raggiungerlo, e segnala tre risorse di esempio da cui iniziare a esplorarlo — la provincia di Torino in AGID, una singola osservazione di pensioni e l'IDPT calcolato di Torino.
