...
La mappa componenti `idpt_components.html` espone **quattro mappe affiancate in CSS grid 2×2** — le 3 componenti separate più l'aggregato finale — per permettere il confronto visuale diretto. Una lettura interessante che emerge dal confronto: D1 (pressione demografica) e D2 (peso economico) hanno gradienti Nord/Sud molto simili (Sud più alto), mentre D3 (eredità storica del retributivo) mostra un gradiente diverso, più legato alla composizione storica del lavoro pubblico nelle singole province che non al gradiente economico complessivo — Sondrio e Belluno, per esempio, mostrano valori D3 alti pur essendo nel Nord, perché hanno alta concentrazione di pensioni di magistrati e impiegati pubblici di carriera lunga. Il limite di questa visualizzazione è che è **uno snapshot 2026**, senza profondità storica: una lettura temporale è però recuperata, da un altro angolo, dal grafico dell'età e dell'importo per anno di decorrenza descritto qui sotto, mentre un'animazione della traiettoria dell'IDPT *aggregato* nel tempo (che richiederebbe i denominatori ISTAT storici provinciali, non disponibili) resta un upgrade post-progetto naturale, citato in 5.4.

**Oltre lo snapshot: l'età e l'importo delle pensioni nel tempo.** L'angolo temporale più istruttivo non è quanti pensionati ci siano, ma *a che età* si è andati in pensione e con *quale assegno*, decennio dopo decennio. Il cubo 4 (pensioni dei dipendenti pubblici per anno di decorrenza, 1980–2025, livello nazionale) alimenta un grafico a linee interattivo — `docs/decorrenza_gdp.html`, generato da `scripts/build_decorrenza.py` che estrae i dati dal cubo 4 via SPARQL e li inietta in una pagina HTML autocontenuta con Chart.js, nella stessa filosofia "singolo file standalone" delle mappe Folium. Il grafico racconta in una sola curva mezzo secolo di riforme: l'**età media alla decorrenza** sale da circa 40 a 67 anni. Agli inizi degli anni Ottanta dominano le celebri **«pensioni baby»** del pubblico impiego (ritiri anche prima dei quarant'anni, soprattutto per le donne), un regime chiuso dalla riforma **Amato 1992**; la **Dini 1995** introduce il metodo contributivo; la **Fornero 2011** spinge l'età ordinaria verso i 67 anni leggibili sulle coorti recenti — tre marcatori verticali nel grafico. Due cautele lo rendono onesto. La prima è il **bias di sopravvivenza**: i valori delle coorti più vecchie riguardano solo i pensionati ancora vigenti nel 2026 (una minoranza atipicamente giovane al ritiro), perciò l'età pre-1995 è indicativa mentre dal 2000 il segnale è pulito. La seconda è la **copertura**: solo dipendenti pubblici, a livello nazionale — il comparto in cui le riforme dell'età si vedono più nitide. L'importo medio (corrente, rivalutato) è meno leggibile e va preso come ordine di grandezza. Resta nel repo, come vista complementare, anche il grafico della serie storica del numero di pensioni 1998–2026 (`docs/serie_storica.html`), che documenta le discontinuità statistiche della fonte INPS (la confluenza di INPDAP/ENPALS nel 2012).
